...
/* From https://github.com/voodoocreation/ts-deepmerge/blob/801421617b46e0e1c1a2f2d593b7cbf487cffddc/src/index.ts#L83
 * But custom null/undefined handling
 */
  ...
  objects.reduce((result, current) => {
    ...
    Object.keys(current).forEach((key) => {
      ...
      if (Array.isArray(result[key]) && Array.isArray(current[key])) {
        ...
        result[key] =
          current[key] === undefined || current[key] === null // This is the custom handling for undefined/null
